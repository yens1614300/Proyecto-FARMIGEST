...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2019 a las 18:15:19
...
INSERT INTO `meses` (`idMes`, `Fecha`, `Mes`) VALUES
(1, '2018-01-01', 'ENERO'),
(2, '2018-02-01', 'FEBRERO'),
(3, '2018-03-01', 'MARZO'),
(4, '2018-04-01', 'ABRIL'),
(5, '2018-05-01', 'MAYO'),
(6, '2018-06-01', 'JUNIO'),
(7, '2018-07-01', 'JULIO'),
(8, '2018-08-01', 'AGOSTO'),
(9, '2018-09-01', 'SEPTIEMBRE'),
(10, '2018-10-01', 'OCTUBRE'),
(11, '2018-11-01', 'NOVIEMBRE'),
(12, '2018-12-01', 'DICIEMBRE');
...
--
ALTER TABLE `detallesalida`
  MODIFY `idDetalleSalida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
